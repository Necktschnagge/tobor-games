...
TEST(engine, example_integration) {
	...
	w.south_wall_by_transposed_id(w.field_id_of(0, 2)).is_wall = true;
	w.south_wall_by_transposed_id(w.field_id_of(0, 10)).is_wall = true;
	w.south_wall_by_transposed_id(w.field_id_of(1, 4)).is_wall = true;
	w.south_wall_by_transposed_id(w.field_id_of(1, 14)).is_wall = true;
	w.south_wall_by_transposed_id(w.field_id_of(2, 2)).is_wall = true;
	w.south_wall_by_transposed_id(w.field_id_of(2, 11)).is_wall = true;
	w.south_wall_by_transposed_id(w.field_id_of(3, 7)).is_wall = true;
	w.south_wall_by_transposed_id(w.field_id_of(6, 3)).is_wall = true;
	w.south_wall_by_transposed_id(w.field_id_of(6, 14)).is_wall = true;
	w.south_wall_by_transposed_id(w.field_id_of(7, 11)).is_wall = true;
	w.south_wall_by_transposed_id(w.field_id_of(9, 2)).is_wall = true;
	w.south_wall_by_transposed_id(w.field_id_of(9, 13)).is_wall = true;
	w.south_wall_by_transposed_id(w.field_id_of(10, 4)).is_wall = true;
	w.south_wall_by_transposed_id(w.field_id_of(11, 10)).is_wall = true;
	w.south_wall_by_transposed_id(w.field_id_of(13, 6)).is_wall = true;
	w.south_wall_by_transposed_id(w.field_id_of(13, 15)).is_wall = true;
	w.south_wall_by_transposed_id(w.field_id_of(14, 3)).is_wall = true;
	w.south_wall_by_transposed_id(w.field_id_of(14, 10)).is_wall = true;
	w.south_wall_by_transposed_id(w.field_id_of(15, 7)).is_wall = true;
	w.south_wall_by_transposed_id(w.field_id_of(15, 12)).is_wall = true;
	...
	auto initial_state = tobor::v1_0::robots_position_state<tobor::v1_0::universal_field_id,3>(
		target_robot,
		std::move(other_robots));
}

...
public:
	...
	public:
		...
		[[nodiscard]] inline bool run(const GameController& controller, std::function<void(const std::string&)> status_callback = nullptr, std::size_t MAX_DEPTH = distance_exploration_type::SIZE_TYPE_MAX, bool explicilty_create_all_optimal_solution_paths = false) {
